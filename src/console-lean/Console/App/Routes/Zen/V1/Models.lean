/-
  Console.App.Routes.Zen.V1.Models - Lean4 Proofs for Models Route
  ...
  Corresponds to: packages/console/app/src/routes/zen/v1/Models.purs
-/

namespace Console.App.Routes.Zen.V1.Models
...
end Console.App.Routes.Zen.V1.Models

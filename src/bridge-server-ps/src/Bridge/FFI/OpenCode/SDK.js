...
// Dynamically imports @opencode-ai/sdk/v2 when available
...
function loadSDK() {
  return new Promise(function(resolve, reject) {
    ...
    try {
      ...
      import("@opencode-ai/sdk/v2").then(function(module) {
        sdkModule = module;
        resolve(module);
  ...
  return function() {
    return new Promise(function(resolve) {
      loadSDK().then(function(module) {
        try {
          var createOpencodeClient = module.createOpencodeClient;
          var client = createOpencodeClient({
  ...
  return function() {
    return new Promise(function(resolve) {
      if (client && client.global && client.global.event) {
        try {
          // OpenCode SDK v2 uses global.event() which returns an async iterable
...
export const nextEvent = function(stream) {
  return function() {
    return new Promise(function(resolve) {
      ...
      // Handle async iterable (SSE stream from OpenCode)
      if (typeof stream[Symbol.asyncIterator] === "function") {
        ...
        iterator.next().then(function(result) {
          if (result.done) {
            ...
            // OpenCode events are GlobalEvent objects with { directory, payload }

...
applyAction state = case _ of
  ...
  Hold -> state  -- TODO: Implement hold
...
lockPiece state piece = do
  ...
  -- Spawn next piece
  let nextPiece = spawnPiece state.nextPiece
...
-- | Spawn new piece
spawnPiece :: PieceType -> { currentPiece :: Maybe Piece, nextPiece :: PieceType }
spawnPiece currentType = do
  let nextType = randomPieceType  -- Would use random generator
...
-- | Generate random piece type (simplified - would use proper RNG)
randomPieceType :: PieceType
randomPieceType = I  -- TODO: Use proper random generator

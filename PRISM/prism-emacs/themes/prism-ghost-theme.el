;;; prism-ghost-theme.el --- Prism Ghost theme -*- lexical-binding: t; -*-
;;; Commentary:
;; Prism Ghost color theme
;;; Code:

(deftheme prism-ghost
  "Prism Ghost - A light theme.")
...
(provide-theme 'prism-ghost)
;;; prism-ghost-theme.el ends here

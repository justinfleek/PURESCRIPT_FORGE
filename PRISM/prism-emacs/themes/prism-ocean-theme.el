;;; prism-ocean-theme.el --- Prism Ocean theme -*- lexical-binding: t; -*-
;;; Commentary:
;; Prism Ocean color theme
;;; Code:

(deftheme prism-ocean
  "Prism Ocean - A dark theme.")
...
(provide-theme 'prism-ocean)
;;; prism-ocean-theme.el ends here

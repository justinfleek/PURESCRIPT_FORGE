...
exports.ThemeGeneratorUI = void 0;
const colorWheel_1 = require("./colorWheel");
const typeGuards_1 = require("./typeGuards");
class ThemeGeneratorUI {
    constructor() {
        this.baseHSL = { h: 211, s: 0.12, l: 0.11 };
        this.heroHSL = { h: 211, s: 1.0, l: 0.66 };
        this.monitorType = "OLED";
        this.blackBalance = 0.11;
        this.themeMode = "dark";
        ...
        this.baseColorWheel = new colorWheel_1.ColorWheel(baseContainer, 300, (hsl) => {
            this.baseHSL = hsl;
            this.updateBaseColorDisplay();
        });
        this.heroColorWheel = new colorWheel_1.ColorWheel(heroContainer, 300, (hsl) => {
            this.heroHSL = hsl;
    ...
    setupControls() {
        ...
        monitorRadios.forEach((radio) => {
            radio.addEventListener("change", (e) => {
                ...
                if ((0, typeGuards_1.isHTMLInputElement)(target)) {
                    const value = target.value;
                    if ((0, typeGuards_1.isValidMonitorType)(value)) {
        ...
        if ((0, typeGuards_1.isHTMLInputElement)(blackBalanceSlider) && blackBalanceValue) {
        ...
        modeRadios.forEach((radio) => {
            radio.addEventListener("change", (e) => {
                ...
                if ((0, typeGuards_1.isHTMLInputElement)(target)) {
                    const value = target.value;
                    if ((0, typeGuards_1.isValidThemeMode)(value)) {
    ...
    updateBlackBalanceRecommendation() {
        ...
        if ((0, typeGuards_1.isHTMLInputElement)(slider) && valueDisplay) {
    ...
    async generateThemes() {
        ...
        try {
            const vscode = (0, typeGuards_1.getVSCodeAPI)();
            vscode.postMessage({
...
exports.ThemeGeneratorUI = ThemeGeneratorUI;

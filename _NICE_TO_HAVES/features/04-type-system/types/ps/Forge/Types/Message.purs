-- | PureScript type definitions for Forge Message types
-- | Phase 2: Type Safety Layer
-- | Mirrors TypeScript/Zod types from forge-dev/packages/forge/src/session/message.ts
module Forge.Types.Message where

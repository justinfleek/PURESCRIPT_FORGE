-- | Forge Integration E2E Tests
-- | End-to-end tests for Forge event processing
module Test.Bridge.E2E.ForgeSpec where
...
-- | Test Forge event processing
testEventProcessing :: forall m. Monad m => m Unit
testEventProcessing = do
  describe "Forge Event Processing E2E" do
    it "processes session events" do
      ...
      -- Process event
      liftEffect $ handleForgeEvent store sessionEvent
    ...
    it "processes message events" do
      ...
      -- Process event
      liftEffect $ handleForgeEvent store messageEvent
    ...
    it "processes file events" do
      ...
      -- Process event
      liftEffect $ handleForgeEvent store fileEvent
    ...
    it "handles invalid events gracefully" do
      ...
      liftEffect $ handleForgeEvent store invalidEvent

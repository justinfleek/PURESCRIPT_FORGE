...
exports.ALL_PRESETS = exports.EASTER_EGG_PRESETS = exports.RESPONSIVE_PRESETS = exports.NEUMORPHISM_PRESETS = exports.BENTO_PRESETS = exports.GLASS_PRESETS = exports.LUXURY_PRESETS = void 0;
exports.getPresetsByCategory = getPresetsByCategory;
exports.getPresetById = getPresetById;
exports.presetToConfig = presetToConfig;
exports.presetToVariant = presetToVariant;
exports.generatePresetGalleryHTML = generatePresetGalleryHTML;
// =============================================================================
// LUXURY MARBLE PRESETS
// =============================================================================
exports.LUXURY_PRESETS = [
    {
        id: "nero_marquina",
        name: "Nero Marquina",
        category: "luxury",
...
function getPresetsByCategory(category) {
    return exports.ALL_PRESETS.filter(p => p.category === category);
}
function getPresetById(id) {
    return exports.ALL_PRESETS.find(p => p.id === id);
}
...
function presetToVariant(preset) {
    return {
        name: preset.id,
 ...
 */
function generatePresetGalleryHTML(presets) {
...
//# sourceMappingURL=presetGallery.js.map
...
exports.wcagAA = wcagAA;
exports.wcagAALarge = wcagAALarge;
exports.wcagAAA = wcagAAA;
exports.adjustLightnessForContrast = adjustLightnessForContrast;
exports.generatePalette = generatePalette;
exports.generateVariants = generateVariants;
exports.generateVSCodeTheme = generateVSCodeTheme;
// ============================================================================
 ...
 */
function adjustLightnessForContrast(color, bg, targetCR, makeLighter) {
    const bgLum = relativeLuminance(bg);
    let lo = makeLighter ? color.L : 0;
    let hi = makeLighter ? 1 : color.L;
    for (let i = 0; i < 50; i++) {
        const mid = (lo + hi) / 2;
        const candidate = { L: mid, C: color.C, H: color.H };
...
// PALETTE GENERATION
// ============================================================================
function generateBackgroundRamp(baseHue, baseSat, startL, mode) {
...
function generateForegroundRamp(baseHue, baseSat, bg, mode) {
    const targetLs = mode === 'dark'
        ? [0.45, 0.75, 0.85, 0.95]
        : [0.55, 0.35, 0.25, 0.15];
    const fgChroma = baseSat * 0.05;
    return targetLs.map((targetL, i) => {
        let oklch = { L: targetL, C: fgChroma, H: baseHue };
...
function generateAccentColors(heroHue, heroSat, bg, mode) {
...
// ============================================================================
function generatePalette(config, bgLightness) {
...
function generateVariants(config) {
    const variantDefs = config.mode === 'dark'
...
// ============================================================================
function generateVSCodeTheme(variant, themeName) {
...
//# sourceMappingURL=prismColor.js.map
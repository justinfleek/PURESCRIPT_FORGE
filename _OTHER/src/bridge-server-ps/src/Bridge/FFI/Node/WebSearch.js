...
// | Execute web search
// | Uses OpenCode SDK web_search tool if available, otherwise falls back to DuckDuckGo API
exports.searchWeb = function(request) {
  return function() {
    return new Promise(function(resolve) {
      try {
      // For now, use DuckDuckGo Instant Answer API as fallback
      // In production, this should integrate with OpenCode SDK's web_search tool

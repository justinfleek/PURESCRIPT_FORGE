...
class ColorWheel {
    constructor(container, size, onColorChange) {
        this.currentHSL = { h: 211, s: 1.0, l: 0.5 };
        this.size = size;
    ...
    draw() {
        ...
        const gradient = ctx.createLinearGradient(sliderX, sliderY, sliderX, sliderY + sliderHeight);

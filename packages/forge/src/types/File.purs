-- | PureScript type definitions for OpenCode File operation types
-- | Phase 2: Type Safety Layer
-- | Mirrors TypeScript types from opencode-dev/packages/opencode/src/util/filesystem.ts
-- | CRITICAL: File reading MUST follow complete read protocol (no grep, head, tail, partial reads)
module Opencode.Types.File where
...
data BannedFileOperation
  = Grep FilePath String
  | Head FilePath Int
  | Tail FilePath Int
  | ReadPartial FilePath Int Int

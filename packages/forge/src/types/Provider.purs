...
data InterleavedCapability
  ...
  | InterleavedObject { field :: String }
...
instance encodeJsonModelStatus :: EncodeJson ModelStatus where
  encodeJson = case _ of
    Alpha -> encodeJson "alpha"
    Beta -> encodeJson "beta"
    Deprecated -> encodeJson "deprecated"
    Active -> encodeJson "active"
...
instance decodeJsonModelStatus :: DecodeJson ModelStatus where
  decodeJson json = do
    ...
    case str of
      ...
      "active" -> pure Active
      _ -> Left (TypeMismatch "Invalid model status")
...
type ModelInfo =
  ...
  , releaseDate :: String
  , variants :: Maybe (Object (Object Json))
  }

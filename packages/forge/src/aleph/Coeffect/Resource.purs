...
Resources form a semilattice under combination (tensor):

@
  -- Semilattice laws:
  Pure tensor r = r                    -- left identity
  r tensor Pure = r                    -- right identity
  r tensor (s tensor t) = (r tensor s) tensor t      -- associativity
  r tensor s = s tensor r              -- commutativity
  r tensor r = r                       -- idempotence
@

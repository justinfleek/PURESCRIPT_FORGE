...
@
  ...
  pure  : forall a. a -> Graded Pure a
  (>>=) : forall r s a b. Graded r a -> (a -> Graded s b) -> Graded (r tensor s) b
  run   : forall r a. Graded r a -> Proof r -> Either DischargeError a
@
...
import Forge.Aleph.Coeffect.Resource (Resource)
import Forge.Aleph.Coeffect.Discharge (DischargeProof, discharge)

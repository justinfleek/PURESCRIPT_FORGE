// FFI for Forge.Tool.Truncation
// 1:1 port from _archive/legacy/opencode-original/opencode-dev/packages/opencode/src/tool/truncation.ts
...
export const output = (text) => (options) => (agent) => async () => {
  ...
  if (lines.length <= maxLines && totalBytes <= maxBytes) {
    return { content: text, truncated: false, outputPath: null };
  }

// FFI for Forge.Tool.Read
// 1:1 port from _archive/legacy/opencode-original/opencode-dev/packages/opencode/src/tool/read.ts
...
import { InstructionPrompt } from "../session/Instruction.js";
...
async function isBinaryFile(filepath, file) {

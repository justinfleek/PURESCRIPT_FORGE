...
@
  edit : EditParams -> Graded (Filesystem paths (x) AST lang?) EditResult

  -- Mode determines coeffect:
  -- Structural: Filesystem (x) AST lang
  -- Text:       Filesystem
...
executeStructural params lang _ctx = do

...
-- |
-- | Base translation dictionary for the UI package.
-- | Contains all UI-related translation keys.
-- |
-- | Source: _OTHER/opencode-original/packages/ui/src/i18n/en.ts
module Forge.UI.I18n.En
  ( dict
  , UiTranslationKey
  ) where

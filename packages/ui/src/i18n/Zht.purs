-- | Traditional Chinese UI Translations
-- |
-- | Source: _OTHER/opencode-original/packages/ui/src/i18n/zht.ts
module Forge.UI.I18n.Zht
  ( dict
  ) where
...
-- | Traditional Chinese translation dictionary
dict :: Object String

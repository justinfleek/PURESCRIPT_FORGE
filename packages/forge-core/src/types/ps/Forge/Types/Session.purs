-- | PureScript type definitions for Forge Session types
-- | Phase 2: Type Safety Layer
-- | Mirrors TypeScript/Zod types from forge-dev/packages/forge/src/session/
module Forge.Types.Session where

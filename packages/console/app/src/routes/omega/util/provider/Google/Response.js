...
export function fromGoogleResponseImpl(respJson) {
  try {
    ...
    const parts = typeof candidateContent === "object" && candidateContent !== null && Array.isArray(candidateContent.parts) ? candidateContent.parts : [];
    ...
    return {
      ...
      model: typeof resp.model === "string" && resp.model.length > 0 ? resp.model : "",
      choices: [
        {
          index: 0,
          message: {

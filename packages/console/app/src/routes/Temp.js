...
export async function renderTempPage() {
  // This would be wrapped in SolidJS Start's page component
  // For now, return the component structure
  function Home() {
    onMount(() => {
        ...
        <div data-component="content">
          ...
          <section data-component="features">
            <ul data-slot="list">
              ...
              <li>
                <strong>opencode omega</strong> A <a href="/docs/omega">curated list of models</a> provided by opencode{" "}
                <label>New</label>
              </li>
              <li>
  ...
  // Return SolidJS component (would be wrapped by SolidJS Start)
  return Home;
}

...
/**
 * Server configuration for forge serve and web commands
 */
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://forge.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://forge.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig

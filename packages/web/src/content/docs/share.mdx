---
title: Share
description: Share your Forge conversations.
---

Forge's share feature allows you to create public links to your Forge conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Forge:
...
Forge supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Forge uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `forge.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using forge in your organization.

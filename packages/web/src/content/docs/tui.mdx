---
title: TUI
description: Using the Forge terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Forge provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Forge starts the TUI for the current directory.
...
When using the Forge TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Forge. Allows you to select from available providers and add their API keys.
...
You can customize TUI behavior through your Forge config file.

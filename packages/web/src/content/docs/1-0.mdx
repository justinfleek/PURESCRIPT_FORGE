...
description: What's new in Forge 1.0.
---

Forge 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same forge server.
...
version. However some older versions of Forge always grab latest.

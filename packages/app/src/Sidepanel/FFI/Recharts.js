...
export const createLineChart = function(elementId) {
...
export const updateChartData = function(chart) {
  return function(data) {
    return function() {
      if (chart) {
        chart.data = data;
...
export const updateChartConfig = function(chart) {
  return function(config) {
    return function() {
      if (chart) {
        chart.config = config;
...
export const disposeChart = function(chart) {
  return function() {
...
// Pie chart functions
export const createPieChart = function(elementId) {
  return function(config) {
    return function(data) {
      return function() {
        var element = document.getElementById(elementId);
...
export const updatePieChartData = function(chart) {
  return function(data) {
    return function() {
      if (chart) {
        chart.data = data;

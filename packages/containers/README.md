...
```
REGISTRY=ghcr.io/forge-ai TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/forge-ai TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/forge-ai/build/bun-node:24.04
```

export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Forge",
  ...
  "desktop.updater.downloaded.prompt": "Версия Forge {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'forge'.",
  "desktop.cli.failed.title": "Ошибка установки",
  "desktop.cli.failed.message": "Не удалось установить CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Не удалось запустить Forge",
  "desktop.error.serverStartFailed.description":
    "Не удалось запустить локальный сервер Forge. Перезапустите приложение или проверьте настройки сети (VPN/proxy) и попробуйте снова.",
}

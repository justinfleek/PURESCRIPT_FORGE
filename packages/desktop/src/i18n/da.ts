export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Forge",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Forge er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'forge'-kommandoen.",
  ...
  "desktop.error.serverStartFailed.description":
    "Den lokale Forge-server kunne ikke startes. Genstart appen, eller tjek dine netværksindstillinger (VPN/proxy) og prøv igen.",
}

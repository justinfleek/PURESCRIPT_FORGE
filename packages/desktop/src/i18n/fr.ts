export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de Forge",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de Forge a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'forge'.",
  "desktop.cli.failed.title": "Échec de l'installation",
  "desktop.cli.failed.message": "Impossible d'installer la CLI : {{error}}",

  "desktop.error.serverStartFailed.title": "Échec du démarrage de Forge",
  "desktop.error.serverStartFailed.description":
    "Impossible de démarrer le serveur Forge local. Redémarrez l'application ou vérifiez vos paramètres réseau (VPN/proxy) et réessayez.",
}

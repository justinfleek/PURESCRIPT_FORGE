export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 Forge",
  ...
  "desktop.updater.downloaded.prompt": "已下載 Forge {{version}} 版本，是否安裝並重新啟動？",
  ...
  "desktop.error.serverStartFailed.title": "Forge 啟動失敗",
  "desktop.error.serverStartFailed.description":
    "無法啟動本地 Forge 伺服器。請重新啟動應用程式，或檢查網路設定 (VPN/proxy) 後再試一次。",
}

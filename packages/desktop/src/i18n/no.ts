export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Forge",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Forge er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'forge'-kommandoen.",
  "desktop.cli.failed.title": "Installasjon mislyktes",
  "desktop.cli.failed.message": "Kunne ikke installere CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Forge kunne ikke starte",
  "desktop.error.serverStartFailed.description":
    "Den lokale Forge-serveren kunne ikke startes. Start appen på nytt, eller sjekk nettverksinnstillingene dine (VPN/proxy) og prøv igjen.",
}

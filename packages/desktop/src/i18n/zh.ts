export const dict = {
  ...
  "desktop.updater.none.message": "你已经在使用最新版本的 Forge",
  ...
  "desktop.updater.downloaded.prompt": "已下载 Forge {{version}} 版本，是否安装并重启？",
  ...
  "desktop.error.serverStartFailed.title": "Forge 启动失败",
  "desktop.error.serverStartFailed.description":
    "无法启动本地 Forge 服务器。请重启应用，或检查网络设置 (VPN/proxy) 后重试。",
}

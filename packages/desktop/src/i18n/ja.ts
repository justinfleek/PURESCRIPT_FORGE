export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Forge を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Forge のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'forge' コマンドを使用してください。",
  "desktop.cli.failed.title": "インストールに失敗しました",
  "desktop.cli.failed.message": "CLI のインストールに失敗しました: {{error}}",

  "desktop.error.serverStartFailed.title": "Forge の起動に失敗しました",
  "desktop.error.serverStartFailed.description":
    "ローカルの Forge サーバーを起動できませんでした。アプリを再起動するか、ネットワーク設定 (VPN/proxy) を確認して再試行してください。",
}

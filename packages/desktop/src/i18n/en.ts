export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Forge",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Forge has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'forge' command.",
  "desktop.cli.failed.title": "Installation Failed",
  "desktop.cli.failed.message": "Failed to install CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Forge failed to start",
  "desktop.error.serverStartFailed.description":
    "The local Forge server could not be started. Restart the app, or check your network settings (VPN/proxy) and try again.",
}

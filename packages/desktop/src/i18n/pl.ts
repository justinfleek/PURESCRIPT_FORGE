export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Forge",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Forge. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'forge'.",
  "desktop.cli.failed.title": "Instalacja nie powiodła się",
  "desktop.cli.failed.message": "Nie udało się zainstalować CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Nie udało się uruchomić Forge",
  "desktop.error.serverStartFailed.description":
    "Nie udało się uruchomić lokalnego serwera Forge. Uruchom ponownie aplikację lub sprawdź ustawienia sieciowe (VPN/proxy) i spróbuj ponownie.",
}

...
const CLI_INSTALL_DIR: &str = ".forge/bin";
const CLI_BINARY_NAME: &str = "forge";
...
pub fn install_cli(app: tauri::AppHandle) -> Result<String, String> {
    ...
    let temp_script = std::env::temp_dir().join("forge-install.sh");
...
pub fn create_command(app: &tauri::AppHandle, args: &str) -> Command {
    ...
    return app
        ...
        .env("FORGE_EXPERIMENTAL_ICON_DISCOVERY", "true")
        .env("FORGE_EXPERIMENTAL_FILEWATCHER", "true")
        .env("FORGE_CLIENT", "desktop")

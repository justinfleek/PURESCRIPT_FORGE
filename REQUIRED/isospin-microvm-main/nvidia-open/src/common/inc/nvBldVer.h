...
// corresponding changes to the buildmeister script
    ...
    #define NV_BUILD_BRANCH             r582_05
#endif
#ifndef NV_PUBLIC_BRANCH
    #define NV_PUBLIC_BRANCH             r582_05
#endif

#if defined(NV_LINUX) || defined(NV_BSD) || defined(NV_SUNOS)
#define NV_BUILD_BRANCH_VERSION         "rel/gpu_drv/r580/r582_05-370"
#define NV_BUILD_CHANGELIST_NUM         (37005162)
#define NV_BUILD_TYPE                   "Official"
#define NV_BUILD_NAME                   "rel/gpu_drv/r580/r582_05-370"
#define NV_LAST_OFFICIAL_CHANGELIST_NUM (37005162)

#else     /* Windows builds */
#define NV_BUILD_BRANCH_VERSION         "r582_05-1"
#define NV_BUILD_CHANGELIST_NUM         (37003728)
#define NV_BUILD_TYPE                   "Official"
#define NV_BUILD_NAME                   "582.08"
#define NV_LAST_OFFICIAL_CHANGELIST_NUM (37003728)

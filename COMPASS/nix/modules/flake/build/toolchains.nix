...
let
  ...
  buck2-toolchain =
    ...
    // lib.optionalAttrs cfg.toolchain.purescript.enable {
      purs = "${purs}/bin/purs";
      spago = "${spago}/bin/spago";
  ...
  packages =
    ...
    ++ lib.optionals cfg.toolchain.lean.enable [ pkgs.lean4 ]
    ++ lib.optionals cfg.toolchain.purescript.enable [ purs spago nodejs pkgs.esbuild ]

...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/forge-ai/forge/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for forge-ai/forge...\n")
...
console.log("Fetching npm all-time downloads for forge-ai...\n")
const npmDownloads = await fetchNpmDownloads("forge-ai")
